...
def home():
    ...
    drawText(-215, 20, "Chơi với người", 12, colors['r'])
    drawText(85, 20, "Chơi với máy", 12, colors['r'])
...
def setting():
    ...
    drawRectangle(-250, 50, 200, 70, colors['r'])
    drawRectangle(50, 50, 200, 70, colors['r'])
    drawText(-215, 20, "Người đi trước", 12, colors['r'])
    drawText(85, 20, "Máy đi trước", 12, colors['r'])
...
def endGame(winner):
    ...
    drawText(6, 4, "Trang chủ", 12, colors['r'])
    drawText(10, 4, "Chơi lại", 12, colors['r'])
...
def drawText(x, y, text, font, pen):
    pen.goto(x, y)
    pen.write(text, font=('Courier', font, 'normal'))
